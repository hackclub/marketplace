...
<header>
    ...
    <div style="font-family: Phantom Sans;" class="text-red-500 text-center mt-20">
     <h1 class="text-red-500 font-bold text-5xl" style="margin-bottom: 20px; margin-top: -50px">Welcome to Hack club Market!</h1>
	<div style="margin-bottom: 20px;">
	 <span class="text-red-500 font-bold text-4xl">What is this?</span> <br style="margin-bottom: 12px;">
	<span class="text-red-500 font-bold text-xl">Hack club market is a marketplace for you to sell PCBs and hardware you design to other teens! <br>
	...
	<div style="margin-bottom: 20px;">
	 <span class="text-red-500 font-bold text-4xl">How do I list a project?</span> <br style="margin-bottom: 12px;">
	...
	You will need a Git Repo, demo images, a demo video, and a description of the project and how it was made. <br>
	Once you list a project, it will be reviewed by our team, and you will be given a grant to spend on production. <br>
	</span>
	</div>
	<div style="margin-bottom: 20px;">
		<span class="text-red-500 font-bold text-4xl">How do I get currency?</span> <br style="margin-bottom: 12px;">
	   <span class="text-red-500 font-bold text-xl">
