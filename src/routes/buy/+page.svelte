...
{:else if shipData}
    <div>
        ...
        <img src={shipData.coverLink} alt={shipData.title} style="margin-left: 80px; max-width: 1000px" class="rounded-xl" />
        <p class="text-4xl font-semibold text-red-500" style="margin-left: 870px; margin-bottom: 10px; margin-top: -580px; font-family: Phantom Sans;">{shipData.title}</p>
        ...
        <p class="text-xl text-black" style="margin-left: 870px; margin-top: 20px; font-family: Phantom Sans;">{shipData.description}</p>
    </div>
