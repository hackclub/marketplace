...
<div class="max-w-2xl mx-auto px-4 py-8">
  <h1 class="text-3xl sm:text-4xl font-bold text-red-500 mb-2" style="font-family: Phantom Sans;">Settings</h1>
  ...
  {:else if success}
    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">Settings saved successfully!</div>
  {:else if settings}
    <form class="bg-[#FFECDA] rounded-xl p-6" style="font-family: Phantom Sans;" on:submit={handleSubmit}>
      <div class="mb-4">
